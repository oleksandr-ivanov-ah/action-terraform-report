...
export default function (data) {
  ...
  data.footer = `This comment was generated by [Terraform Pull Request Report Generator](https://github.com/ahmadnassri/action-terraform-report) - action run [\`#${runId}\`](https://github.com/${owner}/${repo}/actions/runs/${runId}) - commit ${sha}`
